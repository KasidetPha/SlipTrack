...
class _IncomeCardState extends ConsumerState<IncomeCard> {
  ...
  Widget build(BuildContext context) {
    final asyncSummary = ref.watch(summaryProvider(MonthlyKind.income));
    ...
    return asyncSummary.when(
      ...
      data: (summary) {
        ...
        final arrowColor = isZero ? Colors.grey : (isIncrease ? Colors.green[300] : Colors.red[300]);
